...
class ChildsByPackageBloc extends BaseScreenBloc<List<UserActivityModel>> {
  final _service = AppService();

  @override
  Future<Either<Failure, List<UserActivityModel>>> repositoryCall(
      ScreenParams params) {
    if (params is ChildsByPackageParams) {
      return _service.childsByPackage(package: params.packageName);
    }
